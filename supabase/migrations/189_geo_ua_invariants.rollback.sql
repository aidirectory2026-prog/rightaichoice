-- Rollback for 189_geo_ua_invariants.sql — restores the 175 invariants
-- function (drops I14/I15). Old I14/I15 rows in tracking_health age out
-- with the built-in 90-day retention.
