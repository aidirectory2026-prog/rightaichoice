  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      <form onSubmit={handleSubmit} className="relative">
        ...
        <button
          type="submit"
          className={`absolute right-2 top-1/2 -translate-y-1/2 rounded-lg bg-emerald-600 font-medium text-white hover:bg-emerald-500 transition-colors ${
            isLarge ? 'px-5 py-2 text-sm' : 'px-3 py-1 text-xs'
          }`}
        >
          Search
        </button>
