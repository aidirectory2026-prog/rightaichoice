          ...
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/admin/niche-tracker" className="text-sm text-zinc-400 hover:text-white transition-colors">
                  Niche Tracker
                </Link>
                <Link href="/admin/health" className="text-sm text-zinc-400 hover:text-white transition-colors">
                  Health
                </Link>
                <Link href="/admin/ai-citations" className="text-sm text-zinc-400 hover:text-white transition-colors">
                  AI Citations
                </Link>
                <Link href="/admin/onboarding" className="text-sm text-zinc-400 hover:text-white transition-colors">
                  Onboarding
                </Link>
                <Link href="/admin/sentiment" className="text-sm text-zinc-400 hover:text-white transition-colors">
                  Sentiment
                </Link>
