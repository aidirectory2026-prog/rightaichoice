...
export default async function ReconciliationPage({
  ...
  // Mixpanel sees ~70% of client events on tech audiences (industry baseline
  // ad-block rate ~30%). Server events get through always.
  const estMixpanelClient = Math.round(humanEvents * (1 - stats.ad_block_ratio_estimate))
...
function Stat({ label, value, accent }: { label: string; value: number; accent?: 'amber' | 'emerald' | 'blue' }) {
