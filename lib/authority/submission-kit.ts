...
export const BRAND = {
  ...
  // Kept ≤140 chars so it fits the tightest directory fields (e.g. Crunchbase) — one
  // consistent short line everywhere is the consensus/trust signal.
  shortDesc: 'Independent AI-tool decision engine: compare 2,000+ continuously-verified AI tools by features, pricing, viability and sentiment.',
  mediumDesc:
