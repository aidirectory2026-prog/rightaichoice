...
('AutoGPT', 'autogpt', 'Open source autonomous AI agent framework', 'AutoGPT is the pioneering open-source project that demonstrated autonomous AI agents. It chains GPT-4 calls with memory, web browsing, and file operations to accomplish goals independently. Now evolving into a platform with a marketplace for agent templates and plugins.', 'https://autogpt.net', 'free', '[{"plan":"Open Source","price":"$0","features":["Full source code","Self-hosted","Community plugins"]}]', 'advanced', true, '{web,api}', '{"Autonomous goal pursuit","Long-term memory","Web browsing","File operations","Plugin ecosystem","Self-prompting chains","Code execution","Agent marketplace"}', '{"OpenAI API","Google Search","GitHub"}', 'https://docs.agpt.co', true, '{"Developers building AI agents","Open source contributors","AI researchers"}', '{"Non-technical users","Teams wanting managed solutions","Production deployments"}', 'AutoGPT was the project that launched the AI agent wave. The open-source codebase is invaluable for learning, but expect significant tinkering to get reliable results.', now()),

('CrewAI', 'crewai', 'Framework for orchestrating multi-agent AI teams', 'CrewAI is a Python framework for orchestrating role-playing AI agents that work together on complex tasks. Define agents with specific roles, goals, and tools, then assemble them into crews that collaborate. Supports sequential and hierarchical task delegation patterns.', 'https://crewai.com', 'freemium', '[{"plan":"Open Source","price":"$0","features":["Full framework","Unlimited agents","Community support"]},{"plan":"Enterprise","price":"Contact sales","features":["CrewAI+","Managed hosting","Support"]}]', 'advanced', true, '{web,api}', '{"Multi-agent orchestration","Role-based agents","Sequential and hierarchical processes","Custom tool integration","Memory and context sharing","Task delegation","Python framework","Agent collaboration"}', '{"OpenAI","Anthropic","LangChain","HuggingFace"}', 'https://docs.crewai.com', true, '{"Python developers building agent systems","AI engineers","Teams needing multi-agent workflows"}', '{"Non-coders","Simple single-agent use cases","Beginners to AI"}', 'CrewAI is the most elegant multi-agent framework available. The role-playing paradigm makes agent design intuitive, though you need solid Python skills to get the most from it.', now()),
