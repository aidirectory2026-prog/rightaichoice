...
import { Card, EmptyState, countryFlag, fmt, relativeTime } from '../_ui/primitives'
...
export default async function JourneysIndex({ searchParams }: { searchParams: Promise<{ days?: string; range?: string; from?: string; to?: string; q?: string }> }) {
