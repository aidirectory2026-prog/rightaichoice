...
//
// Layout: fixed to the viewport bottom, backdrop-blurred so dark
// content underneath stays legible. The page applies `pb-20 lg:pb-0`
...
export function MobileActionBar({ tool, initialSaved }: Props) {
  return (
    <div className="lg:hidden fixed inset-x-0 bottom-0 z-30 border-t border-zinc-800 bg-zinc-950/95 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/80">
