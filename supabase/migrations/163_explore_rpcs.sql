...
-- ── B.2. Cohort engine + saved views ───────────────────────────────
-- admin_saved_views: named cohort definitions (RLS admin-only).
...
create policy admin_saved_views_admin_all on public.admin_saved_views for all to authenticated
